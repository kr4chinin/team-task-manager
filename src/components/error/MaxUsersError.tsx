...
const MaxUsersError: FC<MaxUsersErrorProps> = ({ setMaxUserWarning }) => {
    ...
    return (
        <article className={cl.container}>
            ...
            <p className={cl['error__paragraph']}> You've reached <b>max amount</b> of users which is <b>500</b>. Delete some of them to add a new one.
            </p>
            <ActionBtn onClick={handleClearStorage} title='I understand' color='red' width='300px' />
        </article>
    )
}
